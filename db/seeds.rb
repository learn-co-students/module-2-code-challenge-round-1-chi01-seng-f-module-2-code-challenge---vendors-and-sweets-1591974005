...
VendorSweet.create(vendor_id: Vendor.first.id, sweet_id: Sweet.first.id, price: 5)
VendorSweet.create(vendor_id: Vendor.last.id, sweet_id: Sweet.second.id, price: 7)
